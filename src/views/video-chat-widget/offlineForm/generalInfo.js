...
const GeneralInfo = (props) => {
  ...
  useEffect(async () => {
    await axios
      .get(
        `${BASE_URL}/api/conversation-management/video-chat-widget/select/offline-contact-form/${id}`
      )
      .then((response) => {
  ...
  const onSubmit = async () => {
    if (1) {
      ...
      await axios
        .post(
          `${BASE_URL}/api/conversation-management/video-chat-widget/edit/offline-contact-form/${id}`,
          {
