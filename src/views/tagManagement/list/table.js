...
const DataTableServerSide = () => {
  ...
  const store = useSelector((state) => state.tagManagement);
  console.log("motherfucker", store);
  // ** States
  ...
  // console.log("pag", getConversationReadCodeList);
  ...
  const dataToRender = () => {
    ...
    // console.log("whaaaaaaaaaaaaaaaa", store.allData);
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Tag"></FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this Tag?"></FormattedMessage>
        </ModalBody>
        <ModalFooter>
          <Button.Ripple
            color="danger"
            onClick={() =>
              dispatch(
                deleteTag(store.isDeleteModalOpen.id),
      ...
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">
            <FormattedMessage id="Tag Managements"></FormattedMessage>
          </CardTitle>
