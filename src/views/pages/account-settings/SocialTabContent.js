...
const SocialTabContent = ({ data }) => {
  ...
  const [google, setGoogle] = useState(
    data.socialLinks.google ? data.socialLinks.google : ""
  );
  ...
  const [quora, setQuora] = useState(
    data.socialLinks.quora ? data.socialLinks.quora : ""
  );
    ...
    if (!isObjEmpty(data.connections.twitter)) {
      return (
        <Fragment>
          <Avatar
            className="mb-1"
            img={data.connections.twitter.profileImg}
            imgHeight="40"
            imgWidth="40"
          />
    ...
    if (!isObjEmpty(data.connections.facebook)) {
      return (
        <Fragment>
          <Avatar
            className="mb-1"
            img={data.connections.facebook.profileImg}
            imgHeight="40"
            imgWidth="40"
          />
    ...
    if (!isObjEmpty(data.connections.google)) {
      return (
        <Fragment>
          <Avatar
            className="mb-1"
            img={data.connections.google.profileImg}
            imgHeight="40"
            imgWidth="40"
          />
    ...
    if (!isObjEmpty(data.connections.github)) {
      return (
        <Fragment>
          <Avatar
            className="mb-1"
            img={data.connections.github.profileImg}
            imgHeight="40"
            imgWidth="40"
          />
