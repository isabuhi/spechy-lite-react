...
// ** Store & Actions
import { getConversationReadCodeList, deleteRole } from "../store/actions";
...
const DataTableServerSide = () => {
  ...
  const store = useSelector((state) => state.roleReducer);
  // ** States
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Role Management"></FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this Role Management?"></FormattedMessage>
        </ModalBody>
        <ModalFooter>
          <Button.Ripple
            color="danger"
            onClick={() =>
              dispatch(
                deleteRole(store.isDeleteModalOpen.id),
        ...
        <CardHeader className="border-bottom">
          ...
          <Button className="ml-2" color="primary" onClick={handleAddClick}>
            ...
            <span className="align-middle ml-50">
              <FormattedMessage id="Add Management List"></FormattedMessage>
            </span>
          </Button>
        </CardHeader>
