...
const DataTableServerSide = () => {
  ...
  const store = useSelector((state) => state.projectReducer);
  // ** States
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Project"></FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this project?"></FormattedMessage>
        </ModalBody>
        <ModalFooter>
          <Button.Ripple
            color="danger"
