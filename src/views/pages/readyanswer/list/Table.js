...
// ** Store & Actions
import { getConversationReadCodeList, deleteAW } from "../store/actions";
...
const DataTableServerSide = () => {
  ...
  const handleAddClick = () => {
    history.push("/readyanswer/add");
  };
  // ** Store Vars
  const dispatch = useDispatch();
  const store = useSelector((state) => state.readyAnswer);
  // ** States
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Template"> </FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this Ready Answer?">
            {" "}
          </FormattedMessage>
        </ModalBody>
        <ModalFooter>
          <Button.Ripple
            ...
            onClick={() =>
              dispatch(
                deleteAW(store.isDeleteModalOpen.id),
      ...
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">
            <FormattedMessage id="Ready Answers"> </FormattedMessage>
          </CardTitle>
          <Button className="ml-2" color="primary" onClick={handleAddClick}>
            <Plus size={15} />
            <span className="align-middle ml-50">
              <FormattedMessage id="Add Ready Answer"> </FormattedMessage>
            </span>
          </Button>
        </CardHeader>
