...
const DataTableServerSide = () => {
  ...
  const handleAddClick = () => {
    history.push("/ticketreasoncode/add");
  };
  // ** Store Vars
  const dispatch = useDispatch();
  const store = useSelector((state) => state.ticketReasonCode);
  // ** States
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Ticket Reason Code"></FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this Ticket Reason Code?"></FormattedMessage>
        </ModalBody>
        <ModalFooter>
          <Button.Ripple
            color="danger"
      ...
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">
            <FormattedMessage id="TicketReasonCodeList"></FormattedMessage>
          </CardTitle>
