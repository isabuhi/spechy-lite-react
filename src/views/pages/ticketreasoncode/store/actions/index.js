...
export const getConversationReadCodeList = (params) => {
  return async (dispatch) => {
    await axios
      .post(
        `${BASE_URL}/api/project-management/reason-codes/ticket/pagination`,
        params
      )
      .then((response) => {
        dispatch({
...
export const getFilterItems = (id) => {
  return async (dispatch) => {
    await axios
      .get(
        `${BASE_URL}/api/project-management/reason-codes/ticket/select/${id}`
      )
      .then((response) => {
...
export const deleteProject = (id) => {
  return async (dispatch) => {
    await axios
      .delete(
        `${BASE_URL}/api/project-management/reason-codes/ticket/delete/${id}`
      )
      .then((res) => {
        dispatch({
          type: "DELETE_TICKET",
