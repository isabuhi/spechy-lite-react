        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Row>
            <Col md={{ size: 6, offset: 2 }}>
              <FormGroup>
                <Label for="name">
                  <FormattedMessage id="Group Name"></FormattedMessage> : <span className="text-danger">*</span>
                </Label>
                <Input
                  type="text"
                  id="name"
              ...
              <FormGroup>
                <Label for="attached">
                  <FormattedMessage id="User List"></FormattedMessage> : <span className="text-danger">*</span>
                </Label>
