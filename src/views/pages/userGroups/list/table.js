...
// ** Store & Actions
import { getUserGroupsList, deleteUserGroups } from "../store/actions";
...
const DataTableServerSide = () => {
  ...
  const handleAddClick = () => {
    history.push("/settings/usergroups/add");
  };
  // ** Store Vars
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete User Group"></FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this User Group?"></FormattedMessage>
        </ModalBody>
        <ModalFooter>
          <Button.Ripple
            color="danger"
            onClick={() =>
              dispatch(
                deleteUserGroups(store.isDeleteModalOpen.id),
        ...
        <CardHeader className="border-bottom">
          ...
          <Button className="ml-2" color="primary" onClick={handleAddClick}>
            ...
            <span className="align-middle ml-50">
              <FormattedMessage id="Add New User Group"></FormattedMessage>
            </span>
          </Button>
        </CardHeader>
