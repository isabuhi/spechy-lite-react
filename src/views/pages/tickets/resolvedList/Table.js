...
const DataTableServerSide = () => {
  ...
  const dataToRender = () => {
    ...
    const result = store.allData.filter((word) => word.status === 2);
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>Delete Ticket Management</ModalHeader>
        <ModalBody>Are you sure to delete this Ticket?</ModalBody>
        <ModalFooter>
          <Button.Ripple
            color="danger"
            onClick={() =>
      ...
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">
            <FormattedMessage id="unresolved tickets"></FormattedMessage>
          </CardTitle>
        </CardHeader>
