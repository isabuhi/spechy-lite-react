...
const DataTableServerSide = () => {
  ...
  const handleAddClick = () => {
    history.push("/reasoncode/add");
  };
  // ** Store Vars
  const dispatch = useDispatch();
  const store = useSelector((state) => state.reasonCode);
  // ** States
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Reason Code"> </FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this Reason Code?">
            {" "}
          </FormattedMessage>
        </ModalBody>
        <ModalFooter>
      ...
      <Card>
        <CardHeader className="border-bottom">
          <CardTitle tag="h4">
            <FormattedMessage id="Conversation Reason Code List">
              {" "}
            </FormattedMessage>
          </CardTitle>
          <Button className="ml-2" color="primary" onClick={handleAddClick}>
            ...
            <span className="align-middle ml-50">
              <FormattedMessage id="Add Reason Code"> </FormattedMessage>
            </span>
          </Button>
        </CardHeader>
