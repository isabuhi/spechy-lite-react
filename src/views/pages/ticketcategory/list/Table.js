...
// ** Store & Actions
import { getCategory, deleteProject } from "../store/actions";
...
const DataTableServerSide = () => {
  ...
  const handleAddClick = () => {
    history.push("/ticketcategory/add");
  };
  // ** Store Vars
  const dispatch = useDispatch();
  const store = useSelector((state) => state.ticketcategory);
  // ** States
  ...
  const dataToRender = () => {
    ...
    console.log("store.data", store.allData);
  ...
  return (
    <Fragment>
      ...
      >
        <ModalHeader>
          <FormattedMessage id="Delete Ticket Category"> </FormattedMessage>
        </ModalHeader>
        <ModalBody>
          <FormattedMessage id="Are you sure to delete this Ticket Category?">
            {" "}
          </FormattedMessage>
        </ModalBody>
        <ModalFooter>
        ...
        <CardHeader className="border-bottom">
          ...
          <Button className="ml-2" color="primary" onClick={handleAddClick}>
            ...
            <span className="align-middle ml-50">
              <FormattedMessage id="addTicketCategory"> </FormattedMessage>
            </span>
          </Button>
        </CardHeader>
